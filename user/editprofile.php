...
$sql = "SELECT id, username, profile_picture FROM users WHERE username = ?";
...
<head>
    ...
    <title>Edit Profile - Niggod</title>
    ...
    <main>
        <div class="container">
            <div class="card bg-dark text-white mb-5">
                <div class="card-body">
                    <h2 class="card-title mb-3">Edit your profile</h2>

                    <form action="editprofile_action.php" method="post" enctype="multipart/form-data">

                        <h5 class="card-text">Set nick</h5>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">@</span>
                            </div>
                            <input type="text" name="username_update" class="form-control" placeholder="Change Your Nick" aria-label="Your Nick" aria-describedby="basic-addon1">
                        </div>

                        <h5 class="card-text">Set bio</h5>
                        <div class="input-group mb-3">
                            <div class=" input-group-prepend">
                                <span class="input-group-text">bio</span>
                            </div>
                            <textarea name="bio_update" rows="1" class="form-control" placeholder="Change Your bio" aria-label="Your bio"></textarea>
                        </div>

                        <h5 class="card-text">Set picture</h5>
