        ...
        <section class="mb-4">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor"
                         class="bi bi-facebook iconSize1" viewBox="0 0 16 16">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor"
                     class="bi bi-twitter iconSize2" viewBox="0 0 16 16">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor"
                     class="bi bi-instagram iconSize3" viewBox="0 0 16 16">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="https://discord.gg/qAtGbg4jfp" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor"
                     class="bi bi-discord iconSize3" viewBox="0 0 16 16">
            ...
            <a class="btn btn-outline-light btn-floating m-1" id="tumblrIcon" href="#!" role="button">
                <svg fill="currentColor" id="Capa_1" xmlns="http://www.w3.org/2000/svg" class="iconSize2" width="46"
                     height="46" x="0px" y="0px" viewBox="0 0 260 260" style="enable-background:new 0 0 260 260;">
            ...
            <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor"
                     class="bi bi-youtube iconSize1" viewBox="0 0 16 16">
